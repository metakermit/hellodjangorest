"""
Django settings for hellodjangorest project.
...
ROOT_URLCONF = 'hellodjangorest.urls'
...
WSGI_APPLICATION = 'hellodjangorest.wsgi.application'
...
GRAPHENE = {
    ...
    'SCHEMA': 'hellodjangorest.schema.schema'
}
